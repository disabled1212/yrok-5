...
namespace Yrok_5
{
    internal class EmployeeBook
    {
        private List<Employee> employee = new List<Employee>(10)
            {
                new("Петр Федоров Николаевич", 1, 10000,1),
                new("Алексей Киселев Валерьевич", 2, 20030,2),
                new("Никита Крючков Сергеевич", 3, 30200,3),
                new("Павел Поперечный Васильевич", 4, 40100,4),
                new("Андрей масло подсолнечное", 5, 12000,5),
